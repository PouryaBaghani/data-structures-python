...
A **doubly linked list** implementation in Python with common operations such as insert, remove, update, find, invert, and concatenate.  
...
Special thanks to our dear friend [iliya](https://github.com/iliyazb84), who gave us the idea of adding the **menu-driven interface** to this project.
